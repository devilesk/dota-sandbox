...
function la_spawn_enemy_at_target:OnSpellStart()
	...
	table.insert( GameRules.herodemo.m_tEnemiesList, CreateUnitByName( GameRules.herodemo.m_sSelectedHero, vTargetPos, true, nil, nil, GameRules.herodemo.m_nENEMIES_TEAM ) )
